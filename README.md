...
## Sample11_28
在**Sample11_27**的基础上修改。初识THREE.js 使用纹理贴图和法向量贴图。使用法向量贴图配合光照可以提高真实度

## Sample11_29
在**Sample11_27**的基础上修改。初识THREE.js 使用凹凸贴图。凹凸贴图一般为灰度图，像素越密集的地方代表凸出的地方越明显

## Sample11_30
在**Sample11_27**的基础上修改。初识THREE.js 使用光照贴图制作静态阴影。物体的阴影计算是一项计算量很大的工作，使用光照贴图可以创建出解析度很高的静态阴影，同时很大程度减少硬件的工作量
