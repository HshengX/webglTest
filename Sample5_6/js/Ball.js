function Ball(								//声明绘制用物体对象所属类
	...
	{	
		...
		gl.uniform3fv(uLightLocationHandle,new Float32Array([lightManager.lx,lightManager.ly,lightManager.lz]));//传入光源方向
		...
		var muRHandle = gl.getUniformLocation(this.program, "uR");//得到半径的引用
		gl.uniform1f(muRHandle,r);//将球体半径传入渲染管线
